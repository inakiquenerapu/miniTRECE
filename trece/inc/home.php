...
<p><strong>Important:</strong> in order to use Markdown as markup language, array item <code>markdown</code> must be set to <code>"true"</code> in <code>trece/conf.php</code> line 60, and the Parsedown library (<a href="https://github.com/erusev/parsedown/blob/master/Parsedown.php">Parsedown.php</a>, <a href="https://github.com/erusev/parsedown-extra/blob/master/ParsedownExtra.php">ParsedownExtra.php</a> and <a href="https://github.com/tovic/parsedown-extra-plugin/blob/master/ParsedownExtraPlugin.php">ParsedownExtraPlugin.php</a>) installed in the <code>trece/lib/parsedown/</code> folder. All those files are included in the .zip which can be downloaded GitHub.</p>
...
<p><strong>Importante:</strong> para poder usar Markdown como lenguaje de marcado, el elemento de array <code>markdown</code> debe ser puesta como <code>"true"</code> en <code>trece/conf.php</code> línea 60, y la biblioteca Parsedown (<a href="https://github.com/erusev/parsedown/blob/master/Parsedown.php">Parsedown.php</a>, <a href="https://github.com/erusev/parsedown-extra/blob/master/ParsedownExtra.php">ParsedownExtra.php</a> y <a href="https://github.com/tovic/parsedown-extra-plugin/blob/master/ParsedownExtraPlugin.php">ParsedownExtraPlugin.php</a>) instalada en la carpeta <code>trece/lib/parsedown/</code>. Todos estos archivos están incluídos en el .zip que puedes descargar de GitHub.</p>
...
<p><strong>Importante:</strong> para poder usar Markdown coma linguaxe de marcado, o elemento de array <code>markdown</code> debe ser posta como <code>"true"</code> en <code>trece/conf.php</code> liña 60, e a biblioteca Parsedown (<a href="https://github.com/erusev/parsedown/blob/master/Parsedown.php">Parsedown.php</a>, <a href="https://github.com/erusev/parsedown-extra/blob/master/ParsedownExtra.php">ParsedownExtra.php</a> e <a href="https://github.com/tovic/parsedown-extra-plugin/blob/master/ParsedownExtraPlugin.php">ParsedownExtraPlugin.php</a>) instalada no cartafol <code>trece/lib/parsedown/</code>. Todos estes arquivos están incluídos no .zip que podes descargar de GitHub.</p>
